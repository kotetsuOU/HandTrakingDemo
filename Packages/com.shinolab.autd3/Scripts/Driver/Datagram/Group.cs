...
namespace AUTD3Sharp
{
    ...
    public sealed class Group : IDatagram
    {
        ...
        DatagramPtr IDatagram.Ptr(Geometry geometry)
        {
            ...
            _del = (IntPtr _, GeometryPtr geometryPtr, ushort devIdx) =>
            {
            ...
            unsafe
            {
                ...
                {
                    var ptr = NativeMethodsBase.AUTDDatagramGroup(new ConstPtr { Item1 = Marshal.GetFunctionPointerForDelegate(_del) }, new ConstPtr { Item1 = IntPtr.Zero },
